...
////////////////parameters/////////////////
const uint8_t no_para = 5;
//const uint8_t paraPerDisp = 4.0;
//const uint8_t  no_disp = ceil((float)no_para / (float)paraPerDisp);

enum para_enum {SOX, NOX, CO, PM2_5, PM10};
String para[no_para] = {"SOX", "NOX", "CO", "PM2.5", "PM10"};
String para_unit[no_para] = {"PPM", "PPM", "PPM", "ug/m^3", "ug/m^3"};
String para_val_str[no_para] = {"0", "0", "0", "0", "0"};
float para_val[no_para];
int eeprom_addr[no_para] = {20, 30, 40, 50, 60};
